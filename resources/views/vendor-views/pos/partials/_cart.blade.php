    ...
    <div class="d-flex flex-column gap-20 pb-9">
        ...
        <div class="">
            ...
            <div class="d-flex gap-2 gap-sm-3 align-items-stretch bottom-absolute-buttons shadow-toast z-1">
                @if($cartQty > 0)
                    <button type="button"
                            class="btn btn-outline-danger btn-block m-0 fs-12-mobile p-2 min-h-40 rounded text-nowrap"
                            data-toggle="modal"
                            data-target="#clearCartModal">
                        {{ translate('clear_Cart')}}
                    </button>
                    <button type="button"
                            class="btn bg-info text-white btn-block m-0 fs-12-mobile p-2 min-h-40 rounded text-nowrap"
                            data-toggle="modal"
                    ...
                    <div class="place-order-wrapper w-100">
                        <button id="submit_order" type="button"
                                class="btn btn--primary btn-block m-0 fs-12-mobile p-2 min-h-40 action-form-submit"
                                data-message="{{ translate('want_to_place_this_order').'?'}}"
                ...
                @else
                    <div title="{{ $clearCartTooltip }}" data-bs-toggle="tooltip" class="flex-grow-1">
                        <button type="button"
                    ...
                    <div title="{{ $holdOrderTooltip }}" data-bs-toggle="tooltip" class="flex-grow-1">
                        <button type="button"
                    ...
                    <div title="{{ $clearCartTooltip }}" data-bs-toggle="tooltip" class="flex-grow-1">
                        <button id="submit_order" type="button"
                                class="btn btn-primary btn-block m-0 fs-12-mobile p-2 min-h-40"
                                disabled>
                            <i class="fa fa-shopping-bag"></i>
                            {{ translate('place_Order') }}
                        </button>
