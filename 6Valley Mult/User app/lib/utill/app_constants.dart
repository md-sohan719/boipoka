import 'package:flutter_sixvalley_ecommerce/common/enums/local_caches_type_enum.dart';
  ...
  static const String appVersion = '16.0'; ///Flutter SDK 3.38.5
  ...
  static const List<String> walletEarnTypeList = [
    'add_fund_by_admin', 'loyalty_point', 'order_place', 'order_refund', 'added_via_payment_method', 'earned_by_referral'
  ];
  ...
  static const List<String> documentExtensions = ['doc', 'docx', 'txt', 'csv', 'xls', 'xlsx', 'rar', 'tar', 'targz', 'zip', 'pdf'];
