...
@section('content')
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-10 flex-md-nowrap justify-content-between mb-4">
                            <div class="d-flex flex-column gap-10 flex-1">
                                ...
                                <div class="d-flex flex-column gap-3">
                                    ...
                                    <div class="bg-section fs-12 p-3 text-dark rounded d-flex gap-2 align-items-center">
                                        <span>
                                            # {{ translate('Note') }}: {{ $order['order_note'] }}
                                        </span>
                                    </div>
                                    @endif

                                    @if($order['payment_method'] == 'cash_on_delivery' && $order['bring_change_amount'] > 0)
                                    <div class="badge badge--success title-color fs-12 font-weight-normal text-wrap p-3 d-flex gap-2 align-items-center">
                                        <span>
                                ...
                                @foreach($order->details as $key=>$detail)
                                    ...
                                    @if($productDetails)
                                        <tr>
                                            <td>{{ ++$row }}</td>
                                            <td>
                                            <div class="{{ $isProductUnavailable ? 'opacity-50 cus-disabled' : '' }}"
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row gy-1 text-sm-right text-dark">
                                    <dt class="col-5 fw-normal">{{translate('item_price')}}</dt>
                                    <dd class="col-6 title-color fw-normal">
                                    ...
                                    <dt class="col-5 text-capitalize fw-normal">{{translate('item_discount')}}</dt>
                                    <dd class="col-6 title-color fw-normal">
                                        -
                                    ...
                                    <dt class="col-5 text-capitalize fw-normal">{{translate('sub_total')}}</dt>
                                    <dd class="col-6 title-color fw-normal">
                                    ...
                                    @endif
                                    <dt class="col-5 text-uppercase fw-normal">
                                    ...
                                    <dt class="col-5 text-capitalize fw-normal">
                                    ...
                                    <dd class="col-6 title-color fw-normal">
                                        <span>{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $orderTotalPriceSummary['shippingTotal']), currencyCode: getCurrencyCode()) }}</span>
                                    </dd>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header pb-0 pt-4">
                    <button type="button" class="close position-absolute right-3 top-3" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
    ...
    <span id="payment-status-message" data-title="{{ translate('confirm_payments_before_change_the_status.') }}" data-message="{{ translate('Change the status to Paid only when you receive the customers payment and have verified it.') }}"></span>
