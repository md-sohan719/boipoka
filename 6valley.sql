...
--
-- Host: localhost:3306
-- Generation Time: Feb 17, 2026 at 04:41 PM
...
('070c766c-d777-11ed-96f4-0c7a158e4469', '2factor', '{\"gateway\":\"2factor\",\"mode\":\"live\",\"status\":\"0\",\"api_key\":\"data\",\"otp_template\":\"OTP1\"}', '{\"gateway\":\"2factor\",\"mode\":\"live\",\"status\":\"0\",\"api_key\":\"data\",\"otp_template\":\"OTP1\"}', 'sms_config', 'live', 0, NULL, '2025-12-15 12:22:36', NULL),
...
(1, 'Admin', '1234567890', 1, 'def.png', NULL, NULL, NULL, 'admin@admin.com', NULL, '$2y$10$38KA8PxXoAsuU5v9ptzeCeZB3n3VQMadqrlEeKYqyiVH8Dr0dxgLW', 'U6KjRJRbQ7p7zoPmmdCBOK7rL9MSwjq9m0ItPweLfrdTtBijA78UUezfNkZr', '2026-02-16 19:44:36', '2026-02-16 19:44:36', 1);
...
(18, 'colors', '{\"primary\":\"#1b7fed\",\"secondary\":\"black\",\"primary_light\":\"#CFDFFB\"}', '2020-10-11 13:53:02', '2025-12-15 12:22:35'),
...
(49, 'social_login', '[{\"login_medium\":\"google\",\"client_id\":\"\",\"client_secret\":\"\",\"status\":1},{\"login_medium\":\"facebook\",\"client_id\":\"\",\"client_secret\":\"\",\"status\":1}]', NULL, '2025-12-15 12:22:35'),
...
(104, 'apple_login', '[{\"login_medium\":\"apple\",\"client_id\":\"\",\"client_secret\":\"\",\"status\":1,\"team_id\":\"\",\"key_id\":\"\",\"service_file\":\"\",\"redirect_url\":\"\"}]', NULL, '2025-12-15 12:22:35'),
...
(0, '127.0.0.1', NULL, '2026-02-16 19:36:35', '2026-02-16 19:36:35'),
...
(16, '127.0.0.1', NULL, '2026-02-16 19:37:21', '2026-02-16 19:37:21'),
(17, '127.0.0.1', NULL, '2026-02-17 14:01:37', '2026-02-17 14:01:37');
...
(7, 'customer', 'order_failed_message', 'Order fa Message', 0, '2023-10-30 11:02:55', '2025-12-15 12:22:35'),
...
INSERT INTO `shops` (`id`, `seller_id`, `author_type`, `name`, `slug`, `address`, `contact`, `image`, `image_storage_type`, `bottom_banner`, `bottom_banner_storage_type`, `offer_banner`, `offer_banner_storage_type`, `vacation_start_date`, `vacation_end_date`, `vacation_duration_type`, `vacation_note`, `vacation_status`, `temporary_close`, `created_at`, `updated_at`, `banner`, `banner_storage_type`, `setup_guide`, `tax_identification_number`, `tin_expire_date`, `tin_certificate`, `tin_certificate_storage_type`, `setup_guide_app`) VALUES
(1, 0, 'admin', '', '-5930', '', '000000000', '2021-03-02-603df1634614f.png', 'public', '', 'public', '', 'public', NULL, NULL, 'until_change', '', 0, 0, '2025-08-12 06:45:54', '2025-08-12 06:45:54', '', 'public', NULL, NULL, NULL, NULL, 'public', NULL);
...
(1, 'App\\Models\\Admin', '1', 'image', 'public', '2026-02-16 19:44:36', '2026-02-16 19:44:36');
...
INSERT INTO `system_tax_setups` (`id`, `tax_type`, `country_code`, `tax_payer`, `tax_ids`, `is_default`, `is_active`, `is_included`, `created_at`, `updated_at`) VALUES
(1, 'order_wise', NULL, 'vendor', NULL, 1, 0, 0, '2026-02-16 19:49:00', '2026-02-16 19:49:00');
...
(0, 'Walk-In Customer', 'Walk-In', 'Customer', '000000000000', 'def.png', 'walking@customer.com', NULL, '', NULL, NULL, '2025-12-15 12:22:36', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, 'en');
...
--
-- Indexes for table `ai_setting_logs`
--
ALTER TABLE `ai_setting_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ai_setting_logs_seller_id_index` (`seller_id`);
...
--
-- Indexes for table `order_details_rewards`
--
ALTER TABLE `order_details_rewards`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `seo_meta_info`
--
ALTER TABLE `seo_meta_info`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `vendor_withdraw_method_infos`
--
ALTER TABLE `vendor_withdraw_method_infos`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `ai_setting_logs`
--
ALTER TABLE `ai_setting_logs`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `order_details_rewards`
--
ALTER TABLE `order_details_rewards`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `seo_meta_info`
--
ALTER TABLE `seo_meta_info`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `vendor_withdraw_method_infos`
--
ALTER TABLE `vendor_withdraw_method_infos`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
